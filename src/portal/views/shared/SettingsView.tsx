...
import { User, Lock, Bell, Shield, Smartphone, Globe, Upload, Key } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="md:col-span-1 space-y-1">
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg font-bold text-[13px] transition-colors text-left ${
              activeTab === "profile"
        ...
        <div className="md:col-span-3 space-y-6">
          ...
          {activeTab === "credentials" && isClient && myClient && (
            <CredentialsManager clientId={myClient.id} />
          )}

          {(activeTab === "security" || activeTab === "notifications" || activeTab === "locale") && (
            <Card>
              <CardHeader 
                title={activeTab === "security" ? "Configurações de Segurança" : activeTab === "notifications" ? "Preferências de Notificações" : "Idioma e Região"}
                subtitle="Esta seção está em desenvolvimento e será integrada ao painel administrativo em breve."
              />
